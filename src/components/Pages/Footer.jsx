            ...
            <div className='container m-auto'>
                <div className='flex justify-between'>
                    <div className='w-3xl p-2'>
                        <div>
                            <img src="src/assets/trendifyImg.png" alt="" className='w-50'/>
                        </div>
                        <div className='w-xl text-sm'>Thank you for shopping with Trendify! We're dedicated to bringing you the 
                    ...
                    <div className='p-2'>
                        ...
                        <div className='text-sm mt-2'>+11-558-669-447</div>
                        <div className='text-sm'>contact.trendify@info.com</div>
                    </div>
                </div>
