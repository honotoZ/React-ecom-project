    ...
    return (
        <>
            <div className='w-[84%] mx-auto mt-13 mb-10'>
                ...
                <div className='flex'>
                    <div className='px-14 py-20 border border-gray-300 flex flex-col gap-5'> 
                    ...
                    <div className='px-14 py-20 border border-gray-300 flex flex-col gap-5'>
                        <h2 className='font-semibold text-sm'>Convenience</h2>
                    ...
                    <div className='px-14 py-20 border border-gray-300 flex flex-col gap-5'>
                        <h2 className='font-semibold text-sm'>Exceptional Customer Service</h2>
